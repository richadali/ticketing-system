    ...
    $("#admin-form").on("submit", function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                console.log(data);
                if (data["flag"] == "Y") {
                    //Succcess for creation of new Admin
                    $(".table_msg1").show();
                    ...
                    //Error while creation of new Admin
                    $(".table_msg2").show();
